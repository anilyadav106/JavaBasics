...
public class hashMap {
	...
	public static void main(String[] args) {
		...
		TreeMap<Integer, String> tree_map = new TreeMap<Integer, String>();   // treemap to have sorted keys
		...
		System.out.println("Keys are greater than 20: " + tree_map.tailMap(20, false)); 		/* false means not inclusive of 20 no key */

		/*
		 * SortedMap is an interface that TreeMap implements. SortedMap guarantees that
		 * the map will be in ascending key order
		 */	
		
		SortedMap<Integer, String> sub_tree_map = new TreeMap<Integer, String>();
		sub_tree_map = tree_map.subMap(20, true, 40, true);   		/*  extracts a portion of the TreeMap from key 20 to key 40, inclusive. */
